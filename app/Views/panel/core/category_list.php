          ...
          if($data)
            ...
            echo '
              <td class="project-actions text-right">
                  <a class="btn btn-info btn-sm" href="' . current_url() . '/edit/' . $row->category_id . '">
                      <i class="fas fa-pencil-alt"> </i>
                  </a>
                  <a class="btn btn-danger btn-sm" onclick="return confirm(\'Bunu Silmek İstediğinizden Emin misiniz ?\')" href="' . current_url() . '/delete/' . $row->category_id . '">
